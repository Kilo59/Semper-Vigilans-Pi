...
#EDIT1:Varify DL Speed Variable | Confirmed & Formated!
    ...
    text_file = open('network_speed.txt', 'w')

    downloadTXT = ('Download: %0.2f M%s/s' %
           ((dlspeed / 1000 / 1000) * args.units[1], args.units[0]))
    text_file.write(currentTime+'\n'+downloadTXT+'\n')
#EDIT1:END
...
#EDIT2:Verify UL Speed Variable | Confirmed & Formated!
    uploadTXT = ('Upload: %0.2f M%s/s' %
           ((ulspeed / 1000 / 1000) * args.units[1], args.units[0]))
    text_file.write(uploadTXT+'\n')
    text_file.close()
